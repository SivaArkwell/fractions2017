...
router.get('/fracResearchFindings', function(req, res, next) {
  res.render('fracResearchFindings', {
    title: "Fractions Research Findings"
  });
});

router.get('/fracResearchSum2015', function(req, res, next) {
  res.render('fracResearchSum2015', {
    title: "Fractions Research Summary"
  });
});

router.get('/fracResearchSum2017', function(req, res, next) {
  res.render('fracResearchSum2017', {
    title: "Fractions Research Summary"
  });
});

router.get('/fracTenLess', function(req, res, next) {
  res.render('fracTenLess', {
    title: "Fractions Top Ten Lessons"
  });
});
...
router.get('/payAttention', function(req, res, next) {
  res.render('payAttention', {
    title: "Paying Attention to Fractions"
  });
});

router.get('/payAttentionOverview', function(req, res, next) {
  res.render('payAttentionOverview', {
    title: "Paying Attention to Fractions Overview"
  });
});
